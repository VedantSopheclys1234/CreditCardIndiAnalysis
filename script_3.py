...
print("\nThe app includes:")
print("- Interactive dashboard with multiple analysis views")
print("- Time series analysis with filtering")
print("- Category-wise spending breakdown")
print("- Geographic analysis by cities")  
print("- Demographic analysis by age, gender, card type")
