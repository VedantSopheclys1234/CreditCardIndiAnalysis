# Create a comprehensive analysis script with machine learning components
analysis_code = '''
"""
...
class CreditCardAnalyzer:
    ...
    def geographic_analysis(self):
        ...
        for i, (city, row) in enumerate(city_spending.head(8).items(), 1):
...
print("- Demographic and geographic analysis")
print("- Customer segmentation using clustering")
print("- Predictive modeling for forecasting")
